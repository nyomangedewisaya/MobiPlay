...
@section('content')
    <div class="w-full max-w-lg  mx-auto">
        ...
        <div class="bg-slate-800 rounded-lg shadow-xl p-8">
            ...
            <p class="text-gray-400 text-center mb-6">Gabung dan nikmati benefitnya!</p>
            <form action="{{ route('register_action') }}" method="POST">
                ...
                <button type="submit"
                    class="mt-6 w-full rounded-lg text-white font-semibold py-2.5 bg-gradient-to-r from-blue-700 via-blue-400 to-blue-700 shadow-[0_0_10px_rgba(59,130,246,0.7)] hover:shadow-[0_0_13px_rgba(59,130,246,0.9)] transition-all duration-300">Daftar</button>
            </form>
            <p class="text-center text-sm text-gray-400 mt-6">
                Sudah punya akun? <a href="{{ route('login') }}" class="font-semibold text-blue-400 hove:underline">Masuk disini</a>
            </p>
        </div>
    </div>
@endsection
